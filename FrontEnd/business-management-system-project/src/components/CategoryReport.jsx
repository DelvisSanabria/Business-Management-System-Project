...
import ExportCategoryReport from "./ExportToExcelBtn/ExportCategoryReport";
...
export default function CategoryReport () {
  ...
  return (
    <>
      <section>
        <div className="border border-[#eaecf0] m-5 p-4 mr-7 rounded-[15px] md:w-[67vw]s lg:hidden">
            ...
            <div className="grid grid-cols-[100px_100px] mx-5">
              <button
                onClick={() => {
                  if (
                    categoryReport &&
                    categoryReport.hasPrevPage &&
                    categoryReport.page > 1
                  ) {
                    handlePrevPage();
                  }
                }}
