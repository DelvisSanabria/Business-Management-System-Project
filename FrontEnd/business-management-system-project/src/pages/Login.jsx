...
function LogIn() {
   ...
   return (
      <section className="pt-[50px] flex flex-col w-full box-border relative h-full pb-10 min-[1440px]:px-[45px] min-[1440px]:gap-[24px] min-[1440px]:bg-[#F1F6F9] min-[1440px]:justify-center max-[1439px]:bg-[#1A3365] max-[1439px]:items-center">
         ...
         <img className="z-0 absolute -bottom-[20px] w-full min-[1440px]:hidden" src={bg_login} alt="background" />
      </section>
   );
}
